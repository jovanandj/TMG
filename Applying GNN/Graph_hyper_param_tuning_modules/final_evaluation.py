...
def main():
    ...
    train_graph, _, test_graph = load_graphs()  # Assuming load_graphs now also returns the test graph
    ...
    accuracy, f1_macro, precision_macro, recall_macro, f1_weighted, precision_weighted, recall_weighted = test_model(model, test_graph, test_batches)
    ...
    with open(filename, 'w', newline='') as csvfile:        
        fieldnames = ['Test accuracy', 'F1 macro', 'Precision macro', 'Recall macro', 'F1 weighted', 'Precision weighted', 'Recall weighted']
